...
export async function fetchGlobalXPLeaderboard(page = 0, size = 20) {
  const res = await authFetch(`${API_BASE}/gamification/leaderboard/global-xp?page=${page}&size=${size}`);
...
export async function fetchWeeklyXPLeaderboard(page = 0, size = 20) {
  const res = await authFetch(`${API_BASE}/gamification/leaderboard/weekly-xp?page=${page}&size=${size}`);
...
export async function fetchWeeklyCoinsLeaderboard(page = 0, size = 20) {
  const res = await authFetch(`${API_BASE}/gamification/leaderboard/weekly-coins?page=${page}&size=${size}`);
...
export async function fetchStreakLeaderboard(page = 0, size = 20) {
  const res = await authFetch(`${API_BASE}/gamification/leaderboard/streaks?page=${page}&size=${size}`);
...
export async function fetchBattleRatingLeaderboard(page = 0, size = 20) {
  const res = await authFetch(`${API_BASE}/gamification/leaderboard/battle-rating?page=${page}&size=${size}`);
...
export async function fetchMyRank(userId, type = "global-xp") {
  const res = await authFetch(`${API_BASE}/gamification/leaderboard/me?type=${type}`);
...
export async function fetchInstitutions() {
  const res = await authFetch(`${API_BASE}/institutions`);

...
const MaximumGap = () => {
    ...
    const CodeLine = ({ line, content }) => (
        <div
            className={`block rounded-md transition-colors ${state.line === line ? "bg-accent-primary-light" : ""
                }`}
        >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="flex gap-8 justify-center mt-6 mb-4">
                            {/* Current Gap */}
                            <div className="bg-theme-elevated/80 px-8 py-4 rounded-xl shadow-lg text-center border border-theme-primary">
                                <p className="text-2xl font-mono text-theme-secondary">
                                    Current Gap:{" "}
